...
with st.sidebar:
    ...
    use_llm = st.checkbox('ใช้ Ollama เรียบเรียงคำตอบจากหลักฐาน', value=False)
    ...
    st.caption('ค้นหลักฐานได้โดยไม่มี API key; เปิด Ollama เพื่อเรียบเรียงคำตอบ')
...
with right:
    ...
    if not data:
        ...
        if question:
            ...
            st.rerun()
st.caption('ประมวลผลภาพในเครื่อง • RAG จากบทสรุปที่คัดไว้ • ตรวจแหล่งข้อมูล 14 ก.ย. 2026')
